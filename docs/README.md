...
A clean and extensible web application designed to help users track personal expenses, categorize spending, visualize totals, and manage their daily financial habits. Built with **HTML, CSS, and JavaScript**, this project serves both as a practical tool and a foundation for future improvements.
...
### API Integration
- Displays real-time data from an external API (weather, currency, quotes, etc.)
